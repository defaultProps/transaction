<template>
  <div id="sortSprint">
    <el-button v-popover:type size="small" type="text" icon="el-icon-info" class="type"></el-button>
    <el-button v-popover:level size="small" type="text" icon="el-icon-info" class="level"></el-button>
    ...
    <el-popover ref="level" placement="bottom" width="160" v-model="visibleLevel">
      <div id="sortSprintMain">
        <div class="work" v-for="(item, index) in levelArr" :key="index">
          ...
          <el-button size="small" type="text" class="currentIcon">
