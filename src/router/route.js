...
let dashboard = r =>
  require.ensure(
    [],
    () => r(require("@/view/dashboard/index")),
    routeErrorCallback,
    "dashboard"
  );
let manage = r =>
...
let initStore = r =>
  require.ensure(
    [],
    () => r(require("@/view/initStore/index")),
    routeErrorCallback,
    "initStore"
  );
